            ...
            <div className="container max-w-7xl mx-auto px-4 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-100/50 dark:bg-indigo-900/30 border border-indigo-200 dark:border-indigo-500/30 backdrop-blur-md text-indigo-700 dark:text-indigo-300 text-sm font-medium shadow-[0_0_15px_rgba(99,102,241,0.2)] hover:bg-indigo-200/50 dark:hover:bg-indigo-900/50 transition-colors cursor-default"
                    >
                    ...
                    >
                        ...
                        <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-600 dark:from-amber-200 dark:via-yellow-100 dark:to-amber-400 animate-shine bg-[length:200%_auto]">
                            Excellence
                        </span>
                    </motion.h1>
                    ...
                    >
                        <SignedOut>
                            <SignInButton mode="modal">
                                <button className="group relative px-8 py-4 bg-emerald-600 hover:bg-emerald-500 dark:bg-emerald-500 dark:hover:bg-emerald-400 text-white dark:text-slate-950 text-lg font-bold rounded-full shadow-[0_0_20px_rgba(16,185,129,0.2)] dark:shadow-[0_0_40px_rgba(16,185,129,0.3)] transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <button
                            ...
                            className="px-8 py-4 rounded-full border border-slate-200 dark:border-white/10 text-muted-foreground hover:text-foreground dark:text-slate-300 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/5 transition-all duration-300 text-lg font-medium flex items-center gap-3 group backdrop-blur-sm"
                        >
                ...
                >
                    {/* Floating Glow */}
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gradient-to-tr from-amber-500/10 to-purple-500/10 dark:from-amber-500/20 dark:to-purple-500/20 rounded-full blur-[100px] animate-pulse-slow" />
                    ...
                    <motion.div
                        ...
                        className="absolute top-[10%] right-[5%] z-20 w-[650px] rounded-[32px] overflow-hidden border border-slate-200 dark:border-white/20 shadow-[0_20px_50px_-10px_rgba(0,0,0,0.1)] dark:shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] bg-white/80 dark:bg-slate-900/90 backdrop-blur-xl"
                    >
                        <Image
                            ...
                            width={1200}
                            height={900}
                            className="w-full h-auto object-cover opacity-95 dark:opacity-90 transition-opacity hover:opacity-100"
                        />
                        {/* Glass Reflection */}
                    ...
                    <motion.div
                        ...
                        className="absolute bottom-[20%] left-[0%] z-30 w-[280px] p-5 rounded-2xl border border-slate-200 dark:border-white/10 bg-white/90 dark:bg-slate-800/80 backdrop-blur-md shadow-xl dark:shadow-2xl"
                    >
                        <div className="flex items-center gap-4 mb-3">
                            ...
                            <div>
                                ...
                                <p className="text-emerald-600 dark:text-emerald-400 text-xs font-bold">+24.5% vs last mo.</p>
                            </div>
                        </div>
                    ...
                    <motion.div
                        ...
                        className="absolute top-[5%] right-[0%] z-10 w-[220px] p-4 rounded-2xl border border-slate-200 dark:border-white/10 bg-white/90 dark:bg-slate-800/80 backdrop-blur-md shadow-xl dark:shadow-2xl"
                    >
                        <div className="flex items-center gap-3">
                            <div className="w-3 h-3 rounded-full bg-amber-500 dark:bg-amber-400 animate-pulse" />
                            <span className="text-slate-600 dark:text-slate-200 text-sm font-medium">Live Attendance</span>
                        </div>
                        <div className="mt-2 text-2xl font-bold text-foreground dark:text-white">98.2%</div>
                    </motion.div>
