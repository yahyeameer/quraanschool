...
interface HeroProps {
    ...
    // Extended to support custom children for buttons if needed
...
const AnimatedShaderHero: React.FC<HeroProps> = ({
    ...
    return (
        <div className={`relative w-full h-[800px] overflow-hidden bg-emerald-950 ${className}`}>
            <style jsx>{`
      ...
      `}</style>
            ...
            <div className="absolute inset-0 z-0">
                ...
                />
                {/* Emerald Tint Overlay to ensure color compatibility */}
            ...
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white p-4">
                            ...
                            {trustBadge.icons && (
                                <div className="flex">
                                    {trustBadge.icons.map((icon, index) => (
                                        <span key={index} className={`text-${index === 0 ? 'emerald' : index === 1 ? 'teal' : 'amber'}-300`}>
                                            {icon}
                                        </span>
                                    ))}
                                </div>
                ...
                <div className="text-center space-y-6 max-w-5xl mx-auto">
                    ...
                    <div className="space-y-4">
                        <h1 className="font-amiri text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-emerald-200 via-white to-amber-200 bg-clip-text text-transparent animate-fade-in-up animation-delay-200 filter drop-shadow-lg">
                            {headline.line1}
                        </h1>
                        <h1 className="font-amiri text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-amber-200 via-yellow-200 to-emerald-200 bg-clip-text text-transparent animate-fade-in-up animation-delay-400 filter drop-shadow-lg">
                            {headline.line2}
                        </h1>
                    </div>
                            ...
                            <>
                                {buttons?.primary && (
                                    <button
                                        ...
                                        className="px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-emerald-500/25"
                                    >
